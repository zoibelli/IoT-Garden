...
Στα συνοδευτικά αρχεία μπορείτε να βρείτε:
- Αναλυτική τεκμηρίωση για το έργο και τις τεχνολογίες που χρησιμοποιούνται.
- Σχηματική αναπαράσταση της δομής του έργου.
- Αναλυτικό κατάλογο με τα απαιτούμενα υλικά και εξοπλισμό, καθώς και το αντίστοιχο κόστος.
